...
// Usamos solo etiquetas <a> estándar en lugar de next/link para mayor compatibilidad.

const NotFound = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0d1117] text-white">
      {/* CORRECCIÓN: Se reemplazó <style jsx={true} global={true}> por una etiqueta <style> simple 
          para evitar conflictos de sintaxis con el App Router de Next.js.
      */}
      <style>{`
        /* ------------------------------------- */
        /* Animación del Robot */
